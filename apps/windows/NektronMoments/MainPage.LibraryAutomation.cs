...
public sealed partial class MainPage
{
        ...
        Func<AiProcessingOptions, Task>? saveAiForVerification = null)
    {
        ...
        content.Children.Add(new TextBlock { Text = "AI connection: Your OpenAI key (BYOK). Previews go directly from this machine to OpenAI; descriptions synchronize to Nektron. Uses the existing WSL OPENAI_API_KEY or ignored .env. Hardware-tuned concurrency: up to 64 AI requests, with preview decoding separately bounded. Local monthly BYOK guard: US$230 per account on this device. This guard is separate from provider billing and legacy cloud usage. NektronAI-managed AI will be added separately.", TextWrapping = TextWrapping.Wrap, FontSize = 13 });
